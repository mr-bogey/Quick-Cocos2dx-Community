...
int lua_cocos2dx_ui_Text_setDisplayNode(lua_State* tolua_S)
{
	int argc = 0;
	cocos2d::ui::Text* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_ui_Text_setDisplayNode'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 1)
	{
		...
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_ui_Text_setDisplayNode'", nullptr);
			return 0;
		}
	...
	luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.Text:setDisplayNode", argc, 1);
	return 0;

#if COCOS2D_DEBUG >= 1
	tolua_lerror:
	tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_ui_Text_setDisplayNode'.", &tolua_err);
#endif
	return 0;
}
...
int lua_register_cocos2dx_ui_Text(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Text");
		...
		tolua_function(tolua_S,"setDisplayNode",lua_cocos2dx_ui_Text_setDisplayNode);
